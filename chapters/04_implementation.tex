...
\addlinespace
\includegraphics[height=1cm]{assets/icons/04-icone_postgresql.png} & PostgreSQL &
La base de données relationnelle porte des entités aux relations
riches (utilisateurs, rôles, permissions, portées).\\
\addlinespace
\includegraphics[height=1cm]{assets/icons/04-icone_sqlalchemy.png} & SQLAlchemy et Alembic &
 Un ORM mature, compatible avec l'écriture asynchrone de FastAPI, évite d'écrire du SQL
brut pour chaque requête. Alembic permet de versionner chaque évolution du schéma sans perte de données
...
écran. \\
\addlinespace
\includegraphics[height=1cm]{assets/icons/04-icone_typescript.png} & TypeScript &
...
\addlinespace
\includegraphics[height=1cm]{assets/icons/04-icone_tailwind.png} & Tailwind CSS &
...
\addlinespace
\includegraphics[height=1cm]{assets/icons/04-icone_nginx.png}
\includegraphics[height=1cm]{assets/icons/04-icone_certbot.png} &
Nginx / Certbot &
...
artificielle, sous la supervision et la validation systématique du développeur à chaque étape.}
...
\begin{itemize}
  \item \textbf{Constat} : Le périmètre du projet a continué
        de s'étendre au fil des sessions, avec l'apparition de domaines
        entiers non prévus au départ.
